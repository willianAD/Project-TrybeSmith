...
Este projeto é importante para fixar o aprendizado de TypeScript. Com ele, eu pratiquei a sintaxe nova, bem como a tipar variáveis e funções, deixando seu código mais compreensível e robusto.
